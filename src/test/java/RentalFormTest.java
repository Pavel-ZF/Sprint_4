...
public class RentalFormTest { //Тестовый клсс (класс в котором будет тест)
    ...
    public static Object[][] userData() {
        return new Object[][] {
                ...
                { 1, "АБДУРАХМАНГАДЖИ", "КЕИХАНАИКУКАУАКАХИХУЛИХЕЕКАХАУНАЕЛЕ","ДОМОЙ", "рум", "+799966997713", "семеро суток", "черный", "Давай скорей, нету мочи ждать, я хочу кататься, хочу я кайфовать, с ветерком вдоль речки смело прокачусь, ездить не умею, но сегодня научусь" }
        };
    }
